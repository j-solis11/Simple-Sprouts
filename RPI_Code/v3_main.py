        ...
        if app_open:
            ...
            if level_under_test == 1 and get_value("levels/bottom/initialized", False):
                ...
                if mode == "manual":
                    ...
                    print("Bottom Level - Scheduling mode")
                else:
                    print("Bottom Level - Continue mode")
            
            if level_under_test == 2 and get_value("levels/top/initialized", False):
                ...
                if mode == "manual":
                    ...
                    print("Top Level - Scheduling mode")
                else:
                    print("Top Level - Continue mode")
        else:
            if get_value("levels/bottom/initialized", False):
                mode = get_value("levels/bottom/mode")
                if mode == "scheduling":
                    print("Bottom Level - Scheduling mode")
                else:
            ...
            if get_value("levels/top/initialized", False):
                mode = get_value("levels/top/mode")
                if mode == "scheduling":
                    print("Top Level - Scheduling mode")
                else:
